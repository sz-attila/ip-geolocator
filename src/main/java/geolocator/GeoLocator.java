 ...
 * implementation uses the <a href="http://ip-api.com/">IP-API</a> service
...
public interface GeoLocator {
     ...
     *
     * @return an object wrapping rhe geolocation information returned
    ...
    /**
     * Returns geolocation information about on IP address or host name specified.
     *
